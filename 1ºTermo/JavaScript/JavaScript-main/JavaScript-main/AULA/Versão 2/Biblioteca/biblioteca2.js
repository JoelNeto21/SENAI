...
function emprestarLivro() {
  let livro = document.getElementById("inpL").value;
  let nome = document.getElementById("inpN").value;
  // Faltou consultar o livro no "banco" de cadastros
  if (livro && nome) {
    document.getElementById("livroEmprestado").innerHTML = `Título: ${livro}<br>Usuário: ${nome}<br><br>EMPRÉSTIMO REALIZADO COM SUCESSO!`;
  } else {
